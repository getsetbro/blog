...
If you are unfamiliar with the Windows UWP bridge it " toolkits enable you to quickly bring your existing applications to the Universal Windows Platform and Windows Store." It wraps web-apps and deploys it to multiple devices (PCs, tablets, phones, HoloLens, Surface Hub, Xbox, and Raspberry Pi).
